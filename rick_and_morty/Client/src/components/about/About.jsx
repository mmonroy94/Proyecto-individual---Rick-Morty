...
const About = () => {
    ...
    <div className={style.aboutMeContainer}>
        ...
        <div className={style.infoContainer}>
            ...
            <p>
                Durante mi tiempo en el bootcamp, he adquirido habilidades sólidas en <span>React, HTML, CSS, y JavaScript</span>. Además de comprender la importancia y poner en práctica el colaborativo, superando obstáculos con creatividad y determinación.
            </p>
            <p>            
